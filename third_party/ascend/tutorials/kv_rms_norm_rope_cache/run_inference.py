...
VALIDATOR = "validate_kv_rms_norm_rope_cache.py"
...
def ensure_triton_available(op_dir: Path) -> None:
    ...
    try:
        ...
        raise SystemExit(
            "Triton-Ascend must be importable with the compiled triton._C.libtriton extension; "
            "run this script with the same Python environment used by OpForge/CANN-Bench."
        ) from exc
